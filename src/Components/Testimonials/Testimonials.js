    ...
    <div>
      <div>
        <h1 className="text-4xl font-bold py-12">
          What CODE ACADEMY student are saying
        </h1>
        <div className="w-full flex flex-col md:flex-row gap-4 mb-8 md:mb-0 flex-between items-center p-8">
          <div className="bg-white dark:bg-gray-800 w-72 shadow-lg mx-auto rounded-xl p-4">
            <p className="text-gray-600 dark:text-white">
              <span className="font-bold text-indigo-500 text-lg">“</span>I was
              asked a lot of security questions at my interview with Tesla and I
              was able to answer them because of Code Academy’s course.
